...
cost2016=pd.read_csv('data/2016/Benefits_Cost_Sharing_PUF.csv',low_memory=False)
rules2014=pd.read_csv('data/2014/Business_Rules_PUF.csv',low_memory=False)
rules2015=pd.read_csv('data/2015/Business_Rules_PUF.csv',low_memory=False)
rules2016=pd.read_csv('data/2016/Business_Rules_PUF.csv',low_memory=False)
